    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="edu-breadcrumb">
                ...
                <li class="separator"><i class="icon-angle-right"></i></li>
                <li class="breadcrumb-item active" aria-current="page">About Us 03</li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="row g-5" id="masonry-gallery">
                        <div class="col-6 masonry-item">
                            <div class="thumbnail thumbnail-1" data-sal-delay="50" data-sal="slide-down" data-sal-duration="1000">
                                <img src="<?php echo $baseUrl; ?>/assets/images/about/about-13.webp" alt="About Images">
                            </div>
                        </div>
                        <div class="col-6 masonry-item">
                            <div class="thumbnail thumbnail-2" data-sal-delay="50" data-sal="slide-down" data-sal-duration="1000">
                                <img src="<?php echo $baseUrl; ?>/assets/images/about/about-14.webp" alt="About Images">
                            </div>
                        </div>
                        <div class="col-6 masonry-item">
                            <div class="thumbnail thumbnail-3" data-sal-delay="50" data-sal="slide-up" data-sal-duration="1000">
                                <img src="<?php echo $baseUrl; ?>/assets/images/about/about-16.webp" alt="About Images">
                            </div>
                        </div>
                        <div class="col-6 masonry-item">
                            <div class="thumbnail thumbnail-4" data-sal-delay="50" data-sal="slide-up" data-sal-duration="1000">
                                <img src="<?php echo $baseUrl; ?>/assets/images/about/about-15.webp" alt="About Images">
                            </div>
                        </div>
                    </div>
                    <ul class="shape-group">
                        <li class="shape-1 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                            <img data-depth="2" src="<?php echo $baseUrl; ?>/assets/images/about/shape-33.png" alt="Shape Images">
                        </li>
                        <li class="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                            <img data-depth="-2" src="<?php echo $baseUrl; ?>/assets/images/about/shape-25.png" alt="Shape Images">
                        </li>
                        <li class="shape-3 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                            <img data-depth="-2" src="<?php echo $baseUrl; ?>/assets/images/about/shape-13.png" alt="Shape Images">
                        </li>
...
<div class="counterup-area-9">
    <div class="container edublink-animated-shape">
        ...
        <ul class="shape-group">
            <li class="shape-1 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                <img data-depth="-1.8" src="<?php echo $baseUrl; ?>/assets/images/others/shape-27.png" alt="Shape Images">
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="container edublink-animated-shape">
        ...
        <div class="row g-5">
            <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="why-choose-box-3 features-box color-primary-style">
                    <div class="thumbnail">
                        <img src="<?php echo $baseUrl; ?>/assets/images/others/why-choose-03.webp" alt="">
                    </div>
                    <div class="content">
                        <div class="icon">
                            <i class="icon-45"></i>
            ...
            <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="why-choose-box-3 features-box color-secondary-style">
                    <div class="thumbnail">
                        <img src="<?php echo $baseUrl; ?>/assets/images/others/why-choose-04.webp" alt="">
                    </div>
                    <div class="content">
                        <div class="icon">
                            <i class="icon-46"></i>
            ...
            <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="why-choose-box-3 features-box color-extra08-style">
                    <div class="thumbnail">
                        <img src="<?php echo $baseUrl; ?>/assets/images/others/why-choose-05.webp" alt="">
                    </div>
                    <div class="content">
                        <div class="icon">
                            <i class="icon-47"></i>
        ...
        <ul class="shape-group">
            <li class="shape-1" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                <img class="rotateit" src="<?php echo $baseUrl; ?>/assets/images/about/shape-13.png" alt="shape">
            </li>
            <li class="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                ...
                <div class="home-four-cta edu-cta-box cta-style-3 bg-image bg-image--16">
                    ...
                    <ul class="shape-group">
                        <li class="shape-01 scene">
                            <img data-depth="2" src="<?php echo $baseUrl; ?>/assets/images/cta/shape-06.png" alt="shape">
                        </li>
                        <li class="shape-02 scene">
                            <img data-depth="-2" src="<?php echo $baseUrl; ?>/assets/images/cta/shape-12.png" alt="shape">
                        </li>
                        <li class="shape-03 scene">
                            <img data-depth="-3" src="<?php echo $baseUrl; ?>/assets/images/cta/shape-04.png" alt="shape">
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="thumbnail-wrap">
                            <div class="thumbnail">
                                <a href="team-details.html">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/team/team-05.webp" alt="team images">
                                </a>
                            </div>
                ...
                <div class="edu-team-grid team-style-3">
                    <div class="inner">
                        <div class="thumbnail-wrap">
                            <div class="thumbnail">
                                <a href="team-details.html">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/team/team-06.webp" alt="team images">
                                </a>
                            </div>
                            <ul class="team-share-info">
                                <li><a href="#"><i class="icon-facebook"></i></a></li>
                ...
                <div class="edu-team-grid team-style-3">
                    <div class="inner">
                        <div class="thumbnail-wrap">
                            <div class="thumbnail">
                                <a href="team-details.html">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/team/team-08.webp" alt="team images">
                                </a>
                            </div>
                            <ul class="team-share-info">
                                <li><a href="#"><i class="icon-facebook"></i></a></li>
    ...
    <div class="container edublink-animated-shape">
        <div class="row row--40">
                            ...
                            <div class="testimonial-slide testimonial-style-3">
                                <div class="content">
                                    ...
                                    <div class="author-info">
                                        <div class="thumb">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/testimonial/testimonial-01.png" alt="Testimonial">
                                        </div>
                                        <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-slide testimonial-style-3">
                                <div class="content">
                                    ...
                                    <div class="author-info">
                                        <div class="thumb">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/testimonial/testimonial-02.png" alt="Testimonial">
                                        </div>
                                        <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-slide testimonial-style-3">
                                <div class="content">
                                    ...
                                    <div class="author-info">
                                        <div class="thumb">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/testimonial/testimonial-03.png" alt="Testimonial">
                                        </div>
                                        <div class="info">
            ...
            <div class="col-lg-6">
                <div class="video-gallery video-gallery-5" data-sal-delay="150" data-sal="slide-left" data-sal-duration="800">
                    <div class="thumbnail">
                        <img src="<?php echo $baseUrl; ?>/assets/images/others/video-03.webp" alt="Thumb">
        ...
        <ul class="shape-group">
            <li class="shape-2 scene" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
                <img data-depth="2" src="<?php echo $baseUrl; ?>/assets/images/about/shape-25.png" alt="Shape">
            </li>
