            ...
            <div class="col-lg-8">
                <div class="blog-details-content">
                    <div class="entry-content">
                        ...
                        <div class="thumbnail">
                            <img src="<?php echo $baseUrl; ?>/assets/images/blog/blog-large-1.jpg" alt="Blog Image">
                        </div>
                    </div>
                    ...
                    <div class="features-image">
                        <div class="row g-md-5">
                            <div class="col-6">
                                <div class="thumb">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/blog/features-1.jpg" alt="Features Images">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="thumb">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/blog/features-2.jpg" alt="Features Images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="blog-author">
                    <div class="thumbnail">
                        <img src="<?php echo $baseUrl; ?>/assets/images/blog/author-01.jpg" alt="Author Images">
                    </div>
                ...
                <div class="comment-area">
                    ...
                    <div class="comment-list-wrapper">
                        ...
                        <div class="comment">
                            <div class="thumbnail">
                                <img src="<?php echo $baseUrl; ?>/assets/images/blog/comment-01.jpg" alt="Comment Images">
                            </div>
                        ...
                        <div class="comment comment-reply">
                            <div class="thumbnail">
                                <img src="<?php echo $baseUrl; ?>/assets/images/blog/comment-02.jpg" alt="Comment Images">
                            </div>
                            <div class="comment-content">
        ...
        <div class="edu-cta-banner">
            ...
            <ul class="shape-group">
                <li class="shape-01 scene">
                    <img data-depth="2.5" src="<?php echo $baseUrl; ?>/assets/images/cta/shape-10.png" alt="shape">
                </li>
                <li class="shape-02 scene">
                    <img data-depth="-2.5" src="<?php echo $baseUrl; ?>/assets/images/cta/shape-09.png" alt="shape">
                </li>
                <li class="shape-03 scene">
                    <img data-depth="-2" src="<?php echo $baseUrl; ?>/assets/images/cta/shape-08.png" alt="shape">
                </li>
                <li class="shape-04 scene">
                    <img data-depth="2" src="<?php echo $baseUrl; ?>/assets/images/about/shape-13.png" alt="shape">
                </li>
            </ul>
        </div>
    </div>
