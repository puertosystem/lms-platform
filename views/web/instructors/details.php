    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <div class="page-title">
                <h1 class="title">Detalles del Instructor</h1>
            </div>
            <ul class="edu-breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo $baseUrl; ?>/">Inicio</a></li>
                <li class="separator"><i class="icon-angle-right"></i></li>
                <li class="breadcrumb-item"><a href="<?php echo $baseUrl; ?>/instructores">Instructores</a></li>
                <li class="separator"><i class="icon-angle-right"></i></li>
        ...
        <div class="row row--40">
            <div class="col-lg-4">
                <div class="team-details-thumb">
                    <div class="thumbnail">
                        <img src="<?php echo $baseUrl; ?>/assets/images/team/team-18.webp" alt="team">
                    </div>
            ...
            <div class="col-lg-8">
                <div class="team-details-content">
                    <div class="main-info">
                        ...
                        <span class="designation">Desarrollador y Profesor</span>
                        <ul class="team-meta">
                            <li><i class="icon-25"></i>20 Estudiantes</li>
                            <li>
                                <div class="rating">
                                    <i class="icon-23"></i>
                                    <i class="icon-23"></i>
                                ...
                                <span class="rating-count">(720 Valoraciones)</span>
                            </li>
                        </ul>
                    </div>
                    <div class="bio-describe">
                        <h4 class="title">Sobre mí</h4>
                    ...
                    <div class="contact-info">
                        <h4 class="title">Contáctame</h4>
                        <ul>
                            <li><span>Dirección:</span>North Helenavile, FV77 8WS</li>
                            <li><span>Email:</span><a href="mailto:edublink@example.com" target="_blank">edublink@example.com</a></li>
                            <li><span>Teléfono:</span><a href="tel:+37(417)683-4409">+37 (417) 683-4409</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="edu-course-area course-area-1 edu-section-gap bg-lighten01">
    <div class="container">
        <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <h2 class="title">Mis Cursos Populares</h2>
        </div>
        <div class="row g-5">
            <!-- Start Single Course  -->
                ...
                <div class="edu-course course-style-1 hover-button-bg-white">
                    <div class="inner">
                        ...
                        <div class="content">
                            ...
                            <h6 class="title">
                                <a href="#">Curso Completo de Camtasia para Creadores</a>
                            </h6>
                            <div class="course-rating">
                                ...
                                <span class="rating-count">(5.0 /9 Valoraciones)</span>
                            </div>
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <h6 class="title">
                                <a href="<?php echo $baseUrl; ?>/cursos/detalle-curso">Curso Completo de Camtasia para Creadores</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
                            ...
                            <a href="<?php echo $baseUrl; ?>/cursos/detalle-curso" class="edu-btn btn-secondary btn-small">Inscribirse <i class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
            </div>
