        ...
        <div class="edu-course-area course-area-1 edu-section-gap bg-lighten01">
            <div class="container">
                        ...
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            ...
                            <div class="course-hover-content">
                                <div class="content">
                                    ...
                                    <a href="<?php echo $baseUrl; ?>/detalle-curso" class="edu-btn btn-secondary btn-small">Enrolled <i class="icon-4"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="course-view-all" data-sal-delay="150" data-sal="slide-up" data-sal-duration="1200">
                    <a href="<?php echo $baseUrl; ?>/cursos" class="edu-btn">Browse more courses <i class="icon-4"></i></a>
                </div>
            </div>
        </div>
        <!-- End Course Area -->
