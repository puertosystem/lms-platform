                ...
                <div class="row g-5">
                    ...
                    <div class="offset-xl-2 col-lg-6">
                        <div class="contact-form form-style-2">
                            ...
                            <ul class="shape-group">
                                <li class="shape-1 scene"><img data-depth="1" src="<?php echo $baseUrl; ?>/assets/images/about/shape-13.png" alt="Shape"></li>
                                <li class="shape-2 scene"><img data-depth="-1" src="<?php echo $baseUrl; ?>/assets/images/counterup/shape-02.png" alt="Shape"></li>
                            </ul>
                        </div>
                    </div>
                </div>
