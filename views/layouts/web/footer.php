	...
	============================================ -->
    <!-- Modernizer JS -->
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/modernizr.min.js"></script>
    <!-- Jquery Js -->
    ...
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/sal.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/jquery.waypoints.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/backtotop.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/magnifypopup.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/jquery.countdown.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/jQuery.rProgressbar.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/easypie.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/odometer.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/isotop.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/imageloaded.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/lightbox.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/paralax.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/paralax-scroll.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/jquery-ui.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/swiper-bundle.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/svg-inject.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/vivus.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/tipped.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/smooth-scroll.min.js"></script>
    <script src="<?php echo $baseUrl; ?>/assets/js/vendor/isInViewport.jquery.min.js"></script>
